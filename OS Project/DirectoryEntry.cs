    ...
    public class DirectoryEntry
    {
       ...
       public DirectoryEntry( char[] fileName, byte fileAttribute, int FirstCluster, int fileSize)
        ...
        public byte[] getByte()
        {
            ...
            // لأن الفيرست كلاستر من نوع انتيجير وانا عايز اخليه 4 بايتات فعملت اراى علشان اخزنه
            for (int i = 24; i < 28; i++)
            {
            ...
            // لأن الفايل سايز من نوع انتيجير وانا عايز اخليه 4 بايتات فعملت اراى علشان اخزنه
            for (int i = 28; i < 32; i++)
            {
